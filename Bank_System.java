...
public static void main(String args[])throws IOException, InterruptedException {
    ...
    System.out.println("Please wait, the Services is starting...");
    while(Option !=5) {
        Thread.sleep(4000);
        ...
        System.out.println();      
        System.out.print("                       Please Chose Option [1-5]: ");
        ...
        switch(Option) {
            ...
            case 4 : System.out.println("Enter a account number :");
                     ...
                     break;
            case 5 : System.out.println("Are you sure , you want to Quit(yes/no):");
                     //confirm = br.readLine();
